            ...
            $('#reindeer').animate({
                ...
                $('#reindeer').animate({
                    ...
                    $(".message").typed({
                        strings: [
                            " Chào mày nhé ! ",
                            "Chúc mày ngày một cáo già hơn, nhiều sỏi trong đầu hơn to bằng gốc cây vào, cho tiền 1000 đô đè chết người mày trong 10 năm nữa, cho cuối đời mày có 100 đứa cháu, cho mày sống lâu đến mức con cháu nó lườm cho bõ ghét… Noel vui vẻ nhé!"
                        ],
